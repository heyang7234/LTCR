                ...
                if(self.contrast_cycle or self.contrast_trend):
                    ...
                    if selected_tids.shape[0] > 1:
                        ...
                        for selected_tid in selected_tids:
                            ...
                            llens = int(250/3)
                            for i in range(3):
                                cycle640_contrast[i].append(selected_samples[2*i][:,:llens].unsqueeze(0).permute(0, 2, 1)) # (1,T,B)
                                cycle640_contrast[i].append(selected_samples[2*i][:,llens:llens*2].unsqueeze(0).permute(0, 2, 1)) # (1,T,B)
                                cycle640_contrast[i].append(selected_samples[2*i][:,llens*2:llens*3].unsqueeze(0).permute(0, 2, 1)) # (1,T,B)
                                cycle640_contrast[i].append(selected_samples[2*i+1][:,:llens].unsqueeze(0).permute(0, 2, 1)) # (1,T,B)
                                cycle640_contrast[i].append(selected_samples[2*i+1][:,llens:llens*2].unsqueeze(0).permute(0, 2, 1)) # (1,T,B)
                                cycle640_contrast[i].append(selected_samples[2*i+1][:,llens*2:llens*3].unsqueeze(0).permute(0, 2, 1)) # (1,T,B)
