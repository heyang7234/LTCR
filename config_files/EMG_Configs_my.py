class Config(object):
    def __init__(self,):
        ...
        self.factors = [0.00, 0.25, 0.25, 0.25]  # patient, trial, sample, observation
        # self.factors = [0.25, 0.0, 0.25, 0.25]  # patient, trial, sample, observation
        # self.factors = [0.0, 0.25, 0.25, 0.25]
        ...
        self.working_directory = 'test_run/models/' + self.dataset + '/' + 'my' + '/'
        self.logging_directory = 'test_run/logs/' + self.dataset + '/' + 'my' + '/'
