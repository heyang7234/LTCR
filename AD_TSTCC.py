...
class COMET:
    ...
    def __init__(
        ...
        self.fc3 = nn.Linear(self.output_dims, 2) # 
        self.fc1.to(device)
        self.fc2.to(device)
        self.fc3.to(device)
        # trend 2
                ...
                if(self.contrast_cycle or self.contrast_trend):
                    ...
                    if selected_tids.shape[0] > 1:
                        ...
                        for selected_tid in selected_tids:
                            ...
                            cycle640_contrast[1].append(selected_samples[6].unsqueeze(0).permute(0, 2, 1)) # 
                            cycle640_contrast[1].append(selected_samples[7].unsqueeze(0).permute(0, 2, 1)) # 
