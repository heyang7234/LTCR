...
import pickle
from OS_CNN_utils.dataloader.utils import pkl_load, pad_nan_to_target
...
def load_arff(dataPath,dataset_name):

    Train_dataset_path = dataPath + '/' + dataset_name + '/' + dataset_name + '_TRAIN.ts'
    Test_dataset_path = dataPath + '/' + dataset_name + '/' + dataset_name + '_TEST.ts'

    train_data = loadarff(Train_dataset_path)[0]
    test_data = loadarff(Test_dataset_path)[0]
